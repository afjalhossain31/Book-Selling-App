...
class CartManager extends ChangeNotifier {
  ...
  // static method jeta instance return kore
  factory CartManager() => _instance;
  CartManager._internal(); // Private constructor

  // List of books in the cart
  final List<Map<String, String>> _cartItems = [];

  // eta private variable jekhane sob data thake like nam, dam
  // Cart er item gula ke bahire theke access korar jonno getter method
  ...
  double calculateSubtotal() {
    ...
    for (var item in _cartItems) {
      double price = double.tryParse(item["price"]!.replaceAll(RegExp(r'[^0-9.]'), '')) ?? 0.0;   // 0.0 default hisabe newa hoi jeno kres na hoi
